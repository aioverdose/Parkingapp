...
-- Clean up any partial runs (policies cascade with their tables)
DROP TABLE IF EXISTS public.spot_matches CASCADE;
DROP TABLE IF EXISTS public.spot_requests CASCADE;
DROP TABLE IF EXISTS public.departure_pings CASCADE;
DROP TABLE IF EXISTS public.ephemeral_messages CASCADE;
DROP TABLE IF EXISTS public.ephemeral_chats CASCADE;
...
DROP TABLE IF EXISTS public.user_ranking CASCADE;
DROP TABLE IF EXISTS public.user_parking_spots CASCADE;
DROP TABLE IF EXISTS public.spot_flags CASCADE;
DROP TABLE IF EXISTS public.spot_predictions CASCADE;
DROP TABLE IF EXISTS public.tips CASCADE;
DROP TABLE IF EXISTS public.invite_conversions CASCADE;
DROP TABLE IF EXISTS public.contribution_stats CASCADE;
DROP TABLE IF EXISTS public.congestion_alerts CASCADE;
DROP TABLE IF EXISTS public.tos_acceptance CASCADE;
DROP TABLE IF EXISTS public.flags CASCADE;
DROP TABLE IF EXISTS public.street_sweeping_alerts CASCADE;
DROP TABLE IF EXISTS public.street_sweeping CASCADE;
DROP TABLE IF EXISTS public.pilot_areas CASCADE;
