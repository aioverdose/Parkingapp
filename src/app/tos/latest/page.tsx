    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 flex flex-col">
      <header className="sticky top-0 z-10 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800 px-6 py-4">
        ...
        <h1 className="text-xl font-bold">Terms of Service</h1>
         <p className="text-sm text-zinc-500">Version {TOS_VERSION} &middot; Community Parking Handoff</p>
         <Link href="/legal" className="mt-2 inline-block text-sm text-blue-600 hover:underline">Legal Center</Link>
      </header>
